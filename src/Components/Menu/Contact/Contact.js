      ...
      <div className="contact-us-banner">
        <section className="ban_sec">
          ...
          <div className="ban_img">
            <img src={contact_banner} alt="contact image banner" />
          ...
          <div className="row">
              ...
              <div className="contact-info">
                <div className="contact-info-item">
                  <div className="contact-info-icon">
                    <ApartmentIcon style={{color: 'white', fontSize: '3rem'}}/>
                  </div>
                  <div className="contact-info-text">
                    <h2>address</h2>
                    <span>178 street - Al Qusais Industrial Area</span>
            ...
            <div className="col-md-4">
              <div className="contact-info">
                <div className="contact-info-item">
                  <div className="contact-info-icon">
                    <ContactMailIcon style={{color: 'white', fontSize: '3rem'}}/>
                  </div>
                  <div className="contact-info-text">
                    <h2>E-mail</h2>
            ...
            <div className="col-md-4">
              <div className="contact-info">
                <div className="contact-info-item">
                  <div className="contact-info-icon">
                    <ScheduleIcon style={{color: 'white', fontSize: '3rem'}}/>
                  </div>
                  <div className="contact-info-text">
                    <h2>office time</h2>
